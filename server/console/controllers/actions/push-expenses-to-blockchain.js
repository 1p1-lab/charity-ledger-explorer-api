/**
 * Module push-expenses-to-blockchain.js
 *
 * Action to load expenses to blockchain
 *
 * Request params:
...
module.exports = async (app, request, response, params) => {
  ...
  const service = app.services.expenses
  ...
  result = await service.pushExpensesToBlockchain(idFoundation, result.items, params)
  if (result.pending) {
