/**
 * Module pull-donations-from-blockchain.js
 *
 * Action to load donations from blockchain to local storage
 *
 * Request params:
...
module.exports = async (app, request, params) => {
  ...
  for (const it = moment(minDate); !it.isAfter(maxDate); it.add(1, 'days')) {
    ...
    await app.services.donations.pullDonationsFromBlockchain(idFoundation, dDoc, params)
  }
}
