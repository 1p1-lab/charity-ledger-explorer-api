/**
 * Module push-programs-to-blockchain.js
 *
 * Action to load foundation programs to blockchain
 *
 * Request params:
...
module.exports = async (app, request, params) => {
  ...
  const service = app.services.programs
  ...
  result = await service.pushProgramsToBlockchain(idFoundation, result.items, params)
  if (result.pending) {
