/**
 * Module push-targets-to-blockchain.js
 *
 * Action to load foundation targets to blockchain
 *
 * Request params:
...
module.exports = async (app, request, params) => {
  ...
  const service = app.services.targets
  ...
  result = await service.pushTargetsToBlockchain(idFoundation, result.items, params)
  if (result.pending) {
