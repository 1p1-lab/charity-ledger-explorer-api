/**
 * Module push-donations-to-blockchain.js
 *
 * Action to load donations to blockchain
 *
 * Request params:
...
module.exports = async (app, request, response, params) => {
  ...
  const service = app.services.donations
  ...
  result = await service.pushDonationsToBlockchain(idFoundation, result.items, params)
  if (result.pending) {
